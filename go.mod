...
require (
	chainguard.dev/driftlessaf v0.9.24
	chainguard.dev/go-grpc-kit v0.17.17
	cloud.google.com/go/storage v1.62.3
	github.com/chainguard-dev/clog v1.8.1
	github.com/chainguard-dev/terraform-infra-common v1.23.0
...
require (
	...
	chainguard.dev/sdk v0.1.154 // indirect
	...
	github.com/octo-sts/app v0.7.2 // indirect
	...
	github.com/snabb/httpreaderat v1.0.3 // indirect
